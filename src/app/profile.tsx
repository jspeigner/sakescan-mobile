          ...
          >
            ...
            <View className="flex-row mt-5 pt-5" style={{ borderTopWidth: 1, borderTopColor: colors.border }}>
              ...
              <View className="flex-1 items-center">
                ...
                <Text className="text-2xl font-bold" style={{ color: colors.text }}>0</Text>
                <Text className="text-xs font-medium" style={{ color: colors.textTertiary }}>{t('profile.following')}</Text>
              </View>
            </View>
          </View>
        </View>
